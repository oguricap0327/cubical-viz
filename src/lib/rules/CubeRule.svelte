  ...
  const cubeRule: RuleDefinition = {
    ...
    judgment: `
      <div class="nd-rule">
        ...
        <div style="margin-top:6px;font-size:0.85rem;opacity:0.85">Faces: ${kt('i{=}0', 'face_i0')}, ${kt('i{=}1', 'face_i1')}, ${kt('j{=}0', 'face_j0')}, ${kt('j{=}1', 'face_j1')}, ${kt('k{=}0', 'face_k0')}, ${kt('k{=}1', 'face_k1')}</div>
      </div>
    `,
    ...
    setup: (scene: THREE.Scene, camera: THREE.Camera) => {
      ...
      cubeRule.termMappings = [
        ...
        { termKey: 'face_j0', objects: [faceMeshes[2]] },
        { termKey: 'face_j1', objects: [faceMeshes[3]] },
        { termKey: 'face_k0', objects: [faceMeshes[4]] },
        { termKey: 'face_k1', objects: [faceMeshes[5]] },
      ];
    },
