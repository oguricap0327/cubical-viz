<script lang="ts">
  ...
  function advance() {
    // Immutable array update forces Svelte 5 to propagate new prop reference to StageNav
    completed = completed.map((v, i) => (i === stage ? true : v));
    if (stage < 3) stage++;
  }
...
<div class="univalence-page">
  ...
  <div class="stage-content">
    ...
    {:else if stage === 3}
      <UniTransport onComplete={advance} onRestart={restart} />
    {/if}
  </div>
</div>
